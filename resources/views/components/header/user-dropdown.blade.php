<div class="relative" x-data="{
    ...
    >
        <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
            <img src="{{ asset('images/user/user.png') }}" alt="User" class="h-full w-full object-cover" />
        </span>
...
<form method="POST" action="{{ route('logout') }}">
    ...
    <button type="submit"
        ...
        @click="closeDropdown()">
        <span class="text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300">
            <!-- (svg icon yang sudah ada di situ biarin aja) -->
        </span>
        Sign out
    </button>
</form>
